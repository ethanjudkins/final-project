...
function Ball:render()
    love.graphics.setColor(128/225, 0/225, 0/225, 225/225)
    --love.graphics.rectangle('fill', self.x, self.y, self.width, self.height)
    love.graphics.circle( "fill", self.x, self.y, 6, 100)
    love.graphics.setColor(225/225, 225/225, 225/225, 225/225)
    love.graphics.circle( "line", self.x, self.y, 6, 100) 
end